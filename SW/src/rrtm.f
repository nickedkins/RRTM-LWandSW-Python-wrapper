...
C       FORM1(1) = '(G15.7,G10.4,G10.4,A3,I2,1X,2(G7.2,G8.3,G7.2))'
      FORM1(1) = '(G15.7,G13.7,G10.4,A3,I2,1X,2(G7.2,G7.3,G10.5))'
C       FORM2(1) = '(G15.7,G10.4,G10.4,A3,I2,23X,(G7.2,G8.3,G7.2))'
      FORM2(1) = '(G15.7,G13.7,G10.4,A3,I2,23X,(G7.2,G8.3,G10.5))'
      FORM3(1) = '(8G15.7)'
...
C      &RM='FORMATTED')
      OPEN(IRDCLD,FILE='/Users/nickedkins/Home GitHub Repositories/RRTM-
     &LWandSW-Python-wrapper/IN_CLD_RRTM NJE',FORM='FORMATTED')
