...
prev_output_file='/Users/nickedkins/Dropbox/GitHub Repositories/RRTM-LWandSW-Python-wrapper/_Current Output/_baseline'
											...
											for ts in range(timesteps):
												...
												for i_lat in range(nlatcols):
													...
													for i_zon in range(nzoncols):
														...
														if((sw_on==1 and ts%500==1) or (input_source==1 and ts==1)):
												...
												if(abs(maxdfnet_tot) < eqb_maxdfnet and ts>100 and np.max(abs(column_budgets_master))<eqb_col_budgs):
													if(plotted!=1):
														plotrrtmoutput()
														plotted=1
